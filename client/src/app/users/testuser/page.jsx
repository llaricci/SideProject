  ...
  const projectList = [
    {
      ...
      description:
        "Roommate Roulette is a full-stack web application designed to help other people find roommate groups with people living in the same area.",
    ...
    },
    {
      ...
      description:
        "TaskMaster is a productivity web application that helps users organize and prioritize their tasks and projects.",
    ...
    },
    {
      ...
      description:
        "BookHub is a platform where users can discover and discuss books, share reviews, and build reading lists.",
