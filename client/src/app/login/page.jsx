    ...
    <div className="justify-center items-center flex">
      <form className="p-10 flex flex-col gap-4 min-h-screen" onSubmit={(e) => {
        ...
        <label className="grid grid-cols-3 items-center">
          ...
          <input type="email" name="email" className=" p-2 border border-gray-300 rounded" required autoFocus onChange={onChange} />
        </label>
        <label className="grid grid-cols-3 items-center">
          <span className="text-right pr-4">Password:</span>
          <input type="password" name="password" className=" p-2 border border-gray-300 rounded" required onChange={onChange} />
        </label>
        <label className="grid grid-cols-3 items-center">
