...
function EditProjectModal(props)
{
    ...
    [
        ...
        return(
            ...
            <div>
            <h1 className="text-2xl font-bold mb-4 text-center">Edit Project Form</h1>
            <h3 className="text-red-500 text-xl mb-4 text-center font-bold underline ">{error}</h3>
        <form id="editProject" onSubmit={projectSubmit} className="space-y-4">
            ...
            <label className="block text-lg font-medium mb-1">Technologies Used:</label>
